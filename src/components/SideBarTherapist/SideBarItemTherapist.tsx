...
export const SideBarMenuItemTherapist = {
...
type SideBarMenuItemPropTypes = PropTypes.InferProps<typeof SideBarMenuItemTherapist>
...
SidebarItem.propTypes = SideBarMenuItemTherapist
